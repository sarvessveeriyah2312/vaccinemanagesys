...
<head>
  ...
  <link rel="stylesheet" href="sources/css/owl.carousel.min.css">
  <link rel="stylesheet" href="sources/css/owl.theme.default.min.css">
  <link rel="stylesheet" href="sources/css/owl.theme.default.min.css">

  <link rel="stylesheet" href="sources/css/jquery.fancybox.min.css">

  <link rel="stylesheet" href="sources/css/bootstrap-datepicker.css">

  <link rel="stylesheet" href="sources/fonts/flaticon/font/flaticon.css">
  <link rel="stylesheet" href="sources/fonts/flaticon-covid/font/flaticon.css">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <figure class="illustration">
              <img src="sources/images/illustration.png" alt="Image" class="img-fluid">
            </figure>
          </div>
          ...
          <div class="col-lg-6 mb-4 mb-lg-0">
            <figure class="img-play-vid">
              ...
              <div class="absolute-block d-flex">
                ...
                <a href="https://youtu.be/oMXGGmBfkf8?si=9rnoyiP2C77Bo3DP" data-fancybox class="btn-play">
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <img src="sources/images/protect.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              <div class="img">
                <img src="sources/images/symptom_high-fever.png" alt="Image" class="img-fluid">
              </div>
              <div class="text">
                <h3>High Fever</h3>
          ...
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              <div class="img">
                <img src="sources/images/symptom_cough.png" alt="Image" class="img-fluid">
              </div>
              <div class="text">
                <h3>Cough</h3>
          ...
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              <div class="img">
                <img src="sources/images/symptom_sore-troath.png" alt="Image" class="img-fluid">
              </div>
              <div class="text">
                <h3>Sore Troath</h3>
          ...
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              <div class="img">
                <img src="sources/images/symptom_headache.png" alt="Image" class="img-fluid">
              </div>
              <div class="text">
                <h3>Headache</h3>
  ...
  <script src="sources/js/jquery.countdown.min.js"></script>
  <script src="sources/js/jquery.easing.1.3.js"></script>
  <script src="sources/js/aos.js"></script>
  <script src="sources/js/jquery.fancybox.min.js"></script>
  <script src="sources/js/jquery.sticky.js"></script>
  <script src="sources/js/isotope.pkgd.min.js"></script>
