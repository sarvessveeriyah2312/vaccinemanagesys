                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="../sources/images/faces/face1.jpg" class="me-2" alt="image"> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="../sources/images/faces/face2.jpg" class="me-2" alt="image"> Stella Johnson
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="../sources/images/faces/face3.jpg" class="me-2" alt="image"> Marina Michel
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="../sources/images/faces/face4.jpg" class="me-2" alt="image"> John Doe
                            </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pe-1">
                        <img src="../sources/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="../sources/images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
                      </div>
                      <div class="col-6 ps-1">
                        <img src="../sources/images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="../sources/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
                      </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                      <img src="../sources/images/faces/face3.jpg" class="img-sm rounded-circle me-3" alt="image">
