...
try {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Handle GET request to search booking numbers
        $searchQuery = $_GET['search'];
        echo searchBookingNumbers($searchQuery);
        exit;
    }
} catch (Exception $e) {
...
// Function to search booking numbers
function searchBookingNumbers($searchQuery) {
    $conn = mysqli_connect("localhost", "root", "", "vaccinemanagesys");
    // Sanitize input
    $searchQuery = mysqli_real_escape_string($conn, $searchQuery);

    $query = "SELECT * FROM vaccinationslot WHERE booking_no LIKE '%$searchQuery%'";
